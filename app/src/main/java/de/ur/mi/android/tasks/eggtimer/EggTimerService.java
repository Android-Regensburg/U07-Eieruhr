...
public class EggTimerService extends Service implements OnEggTimerStatusChangedListener {
   ...
   public void stopTimer() {
      // wenn Eggtimer-Object vorhanden, stoppen des Eggtimer
   ...
   //Notification paket wird erstellt
   private void sendNotification() {
      ...
      // Erstellt einen Intent der zurück zur Activity springt
      Intent resultIntent = new Intent(this, EggTimerActivity.class);

      // Erstellt Stackbuilder Object
      // Parent Activity wird an den Stack angehängt
      // dann wird der oben erstellt Intent an den Stack gehängt
      ...
      // Vibrator mit spezifischen Rhythmus wird definiert
   ...
   private void createNotificationChannel() {
      //Erstellt einen NotificationChannel das ist für API 26+ zwingend
      // NotificationChannel KLasse ist nicht teil der support library
