...
public class EggTimerActivity extends AppCompatActivity {
    ...
    private Spinner variantionSelector;
    ...
    private void initUI() {
        ...
        variantionSelector = findViewById(R.id.egg_variation_selector);
    ...
    private void onStartTimerButtonClicked() {
        ...
        String userSelectedVariation = variantionSelector.getSelectedItem().toString();
